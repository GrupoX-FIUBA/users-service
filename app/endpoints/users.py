...
@router.delete("/users/{user_id}", tags=["Interacciones de Usuario", "Administrador"])
...
@router.patch("/user/{user_id}/update_name/", tags=["Interacciones de Usuario"])
...
@router.patch("/user/{user_id}/update_photo/", tags=["Interacciones de Usuario"])
